...
class InscriptionController extends Controller
{
    ...
    {
        return $this->render('inscription/index.html.twig', ['inscriptions' => $inscriptionRepository->findAll()]);
    }
    ...
    {
        return $this->render('inscription/show.html.twig', ['inscription' => $inscription]);
    }
    ...
    public function edit(Request $request, Inscription $inscription): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('inscription_edit', ['id' => $inscription->getId()]);
        }
